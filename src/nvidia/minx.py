...
__XERRORMSG = {
    1: "Request error. The major or minor opcode of a request is \
invalid.",
...
class XConnectRequest:
    ...
    def __init__(self, byte_order, proto_major, proto_minor, auth_name, auth_data):
        self.encoding = encode(
            XData("BYTE", 1, byte_order),
            XData("PAD", 1, 0),
...
class XListExtensionsRequest:
    ...
    def __init__(self):
        self.encoding = encode(
            XData("CARD8", 1, 99), XData("PAD", 1, 0), XData("CARD16", 1, 1)
        )
